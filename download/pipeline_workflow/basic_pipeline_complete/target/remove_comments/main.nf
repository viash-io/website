  ...
  "resources" : [
    {
      ...
      "path" : "./script.sh",
      "is_executable" : true,
      "parent" : "file:/home/blackdragonbe/GitHub/new_website/download/pipeline_workflow/basic_pipeline_complete/src/remove_comments/config.vsh.yaml"
    }
  ],
...
thisDefaultProcessArgs = [
  ...
  "container" : {
    "image" : "nextflow_modules_remove_comments",
    "tag" : "latest"
  }
}'''),
  // auto settings
