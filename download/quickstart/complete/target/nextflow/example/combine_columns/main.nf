  ...
  "resources" : [
    {
      ...
      "path" : "./script.R",
      "is_executable" : true,
      "parent" : "file:/home/blackdragonbe/GitHub/new_website/download/quickstart/complete/src/example/combine_columns/config.vsh.yaml"
    }
  ],
