  ...
  "resources" : [
    {
      ...
      "path" : "./script.sh",
      "is_executable" : true,
      "parent" : "file:/home/blackdragonbe/GitHub/new_website/download/pipeline_workflow/advanced_pipeline_complete/src/example/remove_comments/config.vsh.yaml"
    }
  ],
