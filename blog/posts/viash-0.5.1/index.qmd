...
We've added C# scripts (.csx) as a [supported language](/guide/component/languages.html) using **dotnet-script**.  
...
To use C# scripts as components, use the new `csharp_script` type in the functionality section of your [config file](/reference/config/overview.html):
