...
A handy new command has been added: `viash config inject`. This can be used to inject a Viash header into a script based on the arguments of the [config file](/reference/config/index.html).
...
You can now include [ADD](https://docs.docker.com/engine/reference/builder/#add) and [COPY](https://docs.docker.com/engine/reference/builder/#copy) instructions in the [config file](/reference/config/index.html):
