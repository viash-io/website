...
:::{.callout-note}
You can choose to install `default-jdk` instead of the more explicit `openjdk-12-jdk`. However, the [Nextflow target platform](/reference/config/platforms/NextflowVdsl3Platform.html) only supports Java version 8 to 12 at this point in time, so keep that in mind.
:::
