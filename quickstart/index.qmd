...
- You can use your [preferred scripting language](/guide/component/create-component.html#create-a-script) per component, and mix and match scripts between multiple components as you please. Supported languages include: Bash, Python, R, Scala, JS and C#.
...
Now that you've had a taste of what Viash can do for you, take a look at our [Guide](/guide/) and [Reference](/reference/) pages to learn more about how to use Viash. If you want to start simple, we suggest to take a look at the [Native component creation guide](/guide/component/create-component.html).