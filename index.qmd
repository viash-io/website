...
::: {.hero-buttons}
[Installation](documentation/installation/){.btn-action-primary .btn-action .btn .btn-success .btn-lg role="button"}
...
[Quickstart](/documentation/quickstart/){.btn-action-primary  .btn-action .btn .btn-success .btn-lg role="button"}
