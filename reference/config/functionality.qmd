...
:::{.callout-note}
When the `license` field is left empty in a component's `.functionality` configuration, the value of `.version` in the [project config](/reference/projectConfig/#) will be copied during build.
:::
...
:::{.callout-note}
When the `organization` field is left empty in a component's `.functionality` configuration, the value of `.version` in the [project config](/reference/projectConfig/#) will be copied during build.
:::
...
:::{.callout-note}
Any repositories defined under `.repositories` in the [project config](/reference/projectConfig/#) will be prepended to the repositories defined in a component's [configuration](/reference/config/functionality.html) of the `.functionality.repositories` field.
:::
...
:::{.callout-note}
When the `version` field is left empty in a component's `.functionality` configuration, the value of `.version` in the [project config](/reference/projectConfig/#) will be copied during build.
:::
