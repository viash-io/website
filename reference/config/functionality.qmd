...
[Resources](#) are files that support the component. The first resource should be [a script](/guide/component/languages.html) that will be executed when the functionality is run. Additional resources will be copied to the same directory.
