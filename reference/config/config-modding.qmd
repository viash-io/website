...
Viash can modify a [viash config](/reference/config/overview.html) at runtime using a custom Domain Specific Language (DSL). This allows making dynamic changes to your components or projects.  
