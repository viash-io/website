...
::: {.callout-warning}
Deprecated since 0.5.15. Planned removal at 0.7.0. Use `setup` instead, e.g. `{type: docker, setup: [{ type: apk, ... }]}`. Will be removed.
:::
...
::: {.callout-warning}
Deprecated since 0.5.15. Planned removal at 0.7.0. Use `setup` instead, e.g. `{type: docker, setup: [{ type: apt, ... }]}`. Will be removed.
:::
...
::: {.callout-warning}
Deprecated since 0.5.15. Planned removal at 0.7.0. Use `setup` instead, e.g. `{type: docker, setup: [{ type: docker, ... }]}`. Will be removed.
:::
...
::: {.callout-warning}
Deprecated since 0.6.3. Planned removal at 0.8.0. Add a `privileged` flag in `run_args` instead, e.g. `{type: docker, run_args: "--privileged"}`.
:::
...
::: {.callout-warning}
Deprecated since 0.5.15. Planned removal at 0.7.0. Use `setup` instead, e.g. `{type: docker, setup: [{ type: python, ... }]}`. Will be removed.
:::
...
::: {.callout-warning}
Deprecated since 0.5.15. Planned removal at 0.7.0. Use `setup` instead, e.g. `{type: docker, setup: [{ type: r, ... }]}`. Will be removed.
:::
...
::: {.callout-warning}
Deprecated since 0.5.15. Planned removal at 0.7.0. Use `setup` instead, e.g. `{type: docker, setup: [{ type: yum, ... }]}`. Will be removed.
:::
