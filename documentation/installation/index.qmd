...
:::{.callout-note}
You can choose to install `default-jdk` instead of the more explicit `openjdk-12-jdk`. However, the [Nextflow target platform](/documentation/reference/config/platforms/nextflowVdsl3Platform.html) only supports Java version 8 to 12 at this point in time, so keep that in mind.
:::
...
<!-- <a href="/documentation/quickstart/index.html?lang=bash" role="button" class="btn btn-outline-light">
![Bash](/images/lang-bash.svg)Bash
</a>

<a href="/documentation/quickstart/index.html?lang=csharp" role="button" class="btn btn-outline-light">
![C#](/images/lang-csharp.svg)C#
</a>

<a href="/documentation/quickstart/index.html?lang=js" role="button" class="btn btn-outline-light">
![JavaScript](/images/lang-js.svg)JavaScript
</a>

<a href="/documentation/quickstart/index.html?lang=python" role="button" class="btn btn-outline-light">
![Python](/images/lang-python.svg)Python
</a>

<a href="/documentation/quickstart/index.html?lang=scala" role="button" class="btn btn-outline-light">
![Scala](/images/lang-scala.svg)Scala
</a>

<a href="/documentation/quickstart/index.html?lang=r" role="button" class="btn btn-outline-light">
![R](/images/lang-r.svg)R
</a> -->


The [Quickstart](/documentation/quickstart/) will guide you through the process of creating a Viash component, generating a Nextflow module and incorporating that into a new pipeline.
