...
to use generated modules inside an actual Nextflow pipeline, see [Pipeline Basics](/documentation/guide/data-workflow/nextflow-pipeline/pipeline-basics.html)