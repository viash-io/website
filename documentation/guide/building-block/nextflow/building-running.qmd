...
To start off, either follow along with the [Nextflow component creation guide](/documentation/guide/component/creation/nextflow.html) to create a simple `hello_world` component that targets Nextflow or download the zip below containing the component in all [supported languages](/documentation/guide/component/languages.html).  
