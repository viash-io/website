---
title: Building and Running Advanced
search: true
---
...
Next, use the [viash build](/documentation/reference/viash/build.html) command to generate a Nextflow module inside of a **target/remove_comments** directory:
