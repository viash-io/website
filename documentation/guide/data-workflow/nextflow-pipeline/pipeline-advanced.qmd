...
9. Concatenate the TSVs into one by running the `combine_columns` module with [auto publishing](/documentation/reference/config/platforms/nextflowVdsl3Platform.html#auto) enabled using the `auto` directive to 
