...
To get started, open up **config.vsh.yaml** file and take a look at the end of the [functionality](/documentation/reference/config/functionality.html) dictionary, between the `path: script.sh` and `platforms:` lines:
