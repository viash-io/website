...
For this example, you'll use the same `hello_world` component the [native component creation guide](/documentation/guide/component/creation/native.html) uses. You can either follow with that guide first or simply download the component below that contains the component in all [supported languages](/documentation/guide/component/languages.html).
