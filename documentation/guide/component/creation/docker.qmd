...
The `docker` platform has an image property that points to a [Docker image](/documentation/reference/config/platforms/dockerPlatform.html#image) from [Docker Hub](https://hub.docker.com/) to use as a base.  
