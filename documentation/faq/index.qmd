...
You can set up the [chown attribute](/documentation/reference/config/platforms/DockerPlatform.html#chown) in your config file to automatically transfer the ownership of files to the user running the component. Any file output where an argument of the type file with an output direction was used will also have their ownership transferred.
...
In the [resources](/documentation/reference/config/functionality.html#resources) section of the [Viash config file](/documentation/reference/config/overview.html):
