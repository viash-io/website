...
:::{.callout-important}
This guide assumes you've [installed Viash, Docker and Nextflow](/documentation/installation/) on your system. 
:::
...
- **src** contains three [Viash components](/documentation/guide/), each with a [config file](/documentation/reference/config/overview.html) and a [script](/documentation/guide/component/languages.html)
...
Now that you've had a taste of what Viash can do for you, take a look at our [Guide](/documentation/guide/) and [Reference](/documentation/reference/) pages to learn more about how to use Viash. If you want to start simple, we suggest to take a look at the [Native component creation guide](/documentation/guide/component/creation/native.html).