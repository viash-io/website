...
All [resources](/api/config/functionality/#resources-list) defined in the [config file](/api/config/config/) are copied over to a temporary location right before a Viash component is executed. This location is can now be easily accessed in your scripts, allowing you to modify and copy the files as needed.  
