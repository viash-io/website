...
You can read more about this option in the [Fenced Echo](https://quarto.org/documentation/computations/execution-options.html#fenced-echo) documentation.
...
See the [Knitr Cell Options](https://quarto.org/documentation/reference/cells/cells-knitr.html) documentation for additional details.
...
Note that we have also updated the narrative with a [cross reference](https://quarto.org/documentation/authoring/cross-references.html#computations) to this figure using the following.
...
See the article [Figure Layout](https://tutorial.quarto.org/documentation/authoring/figure-layout.html) for details.
...
See the documentation on [Article Layout](https://tutorial.quarto.org/documentation/authoring/article-layout.html) to learn about all of the available layout options.
...
You can find out more about caching in Quarto documents in the [Cache](https://quarto.org/documentation/projects/code-execution.html#cache) documentation.
