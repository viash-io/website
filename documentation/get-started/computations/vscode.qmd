...
See the [Jupyter Cell Options](https://quarto.org/documentation/reference/cells/cells-jupyter.html) documentation for additional details.
...
See the article [Figures](/documentation/authoring/figures.qmd) for details.
...
See the documentation on [Article Layout](/documentation/authoring/article-layout.qmd) to learn about all of the available layout options.
