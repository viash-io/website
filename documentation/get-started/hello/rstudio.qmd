...
Quarto is a multi-language, [next-generation](/documentation/faq/rmarkdown.qmd) version of R Markdown from RStudio, and includes dozens of new features and capabilities while at the same being able to render most existing Rmd files without modification.
...
The new file can be an [HTML](https://quarto.org/documentation/output-formats/all-formats.html), [PDF](https://quarto.org/documentation/output-formats/pdf-basics.html), [MS Word](https://quarto.org/documentation/output-formats/ms-word.html) document, [presentation](https://quarto.org/documentation/presentations/), [website](https://quarto.org/documentation/websites/), [book](https://quarto.org/documentation/books/), [interactive document](https://quarto.org/documentation/interactive/), or [other format](https://quarto.org/documentation/output-formats/all-formats.html).
...
RStudio's [visual editor](/documentation/visual-editor/) offers an [WYSIWYM](https://en.wikipedia.org/wiki/WYSIWYM) authoring experience for markdown.
...
You can find out about all available YAML fields for HTML documents [here](/documentation/reference/formats/html.html).
The available YAML fields vary based on document format, e.g. see [here](/documentation/reference/formats/pdf.html) for YAML fields for PDF documents and [here](/documentation/reference/formats/docx.html) for MS Word.
