...
At the end of this article there is a link to documentation on using the [Notebook Editor](/documentation/tools/vscode.qmd#notebook-editor) with Quarto that will apply what you've learned to notebooks.
:::
...
See the article on [Using Julia](/documentation/computations/julia.qmd) for additional details.
:::
...
![](/documentation/tools/images/vscode-render-button.png){.border fig-alt="The top of the Visual Studio code editor. The right side of the editor tab area includes a Render button."}
...
![](/documentation/tools/images/vscode-execute-cell.png){.border}
...
There are a wide variety of [cell options](/documentation/reference/cells/cells-jupyter.qmd) that you can apply to tailor your output.
...
![](/documentation/tools/images/vscode-preview-settings.png){.border}

``` include
_footer.md
```

Additionally, if you are interested in seeing how to use Quarto from within `.ipynb` notebooks, check out the documentation on using the VS Code [Notebook Editor](/documentation/tools/vscode.qmd#notebook-editor) with Quarto.
