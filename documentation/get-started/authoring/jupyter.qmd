...
![](/documentation/get-started/authoring/images/jupyter-equation.png){.border}

Equations are rendered when you run the cell.

![](/documentation/get-started/authoring/images/jupyter-equation-render.png){.border}
...
![](/documentation/get-started/authoring/images/jupyter-citations.png){.border}
...
![](/documentation/get-started/authoring/images/jupyter-crossref.png){.border}
...
![](/documentation/get-started/authoring/images/jupyter-callout.png){.border}
...
![](/documentation/get-started/authoring/images/jupyter-callout-render.png){.border}
