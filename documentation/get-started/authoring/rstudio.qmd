...
The [visual markdown editor](/documentation/visual-editor/) in RStudio makes many of these tasks easier so we'll highlight its use in this tutorial, but note that it's possible to accomplish these tasks in the source editor as well.
...
The [Presentations](/documentation/presentations/) article gives a thorough walk through of creating slide decks with Quarto.
...
If you are using the visual editor mode, you can add LaTeX equations to Quarto documents in RStudio using the [Insert Anything](/documentation/visual-editor/index.qmd#insert-anything) tool.
...
![](/documentation/get-started/authoring/images/rstudio-equation-render.png){.border}
...
In the next window you can insert a citation via from a variety of sources including your document bibliography, [Zotero](/documentation/visual-editor/technical.qmd#citations-from-zotero) personal or group libraries, [DOI](/documentation/visual-editor/technical.qmd#citations-from-dois) (Document Object Identifier) references, and searches of [Crossref](https://www.crossref.org/), [DataCite](https://datacite.org/), or [PubMed](https://pubmed.ncbi.nlm.nih.gov/).
You can find out more about citations with the visual editor [here](/documentation/visual-editor/technical.qmd#citations).
...
The [Publishing HTML](/documentation/output-formats/html-publishing.html) article gives a much more detailed overview of your publishing options.
