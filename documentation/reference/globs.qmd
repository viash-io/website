...
- When specifying render targets in Quarto projects (see [Render Targets](/documentation/projects/quarto-projects.qmd#render-targets)).
- When defining resources for Quarto websites (see [Site Resources](/documentation/websites/website-tools.qmd#site-resources)).
- When defining documents to include in a listing (see [Listing Contents](/documentation/websites/website-listings.qmd#listing-contents)).
