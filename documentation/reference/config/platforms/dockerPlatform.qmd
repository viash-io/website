...
A list of requirements for installing the following types of packages:
 ...
 - [apt](/documentation/reference/config/requirements/aptRequirements.html)
 - [apk](/documentation/reference/config/requirements/apkRequirements.html)
 - [yum](/documentation/reference/config/requirements/yumRequirements.html)
 - [R](/documentation/reference/config/requirements/rRequirements.html)
 - [Python](/documentation/reference/config/requirements/pythonRequirements.html)
 - [JavaScript](/documentation/reference/config/requirements/javascriptRequirements.html)
 - [Docker setup instructions](/documentation/reference/config/requirements/dockerRequirements.html)
