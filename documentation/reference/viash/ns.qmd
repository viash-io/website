...
|-|:----|-:
| `--config_mod`, `-c` | Modify a viash config at runtime using a [custom DSL](/documentation/reference/config/config-modding.html).  | `List[String]` |
...
| `--query`, `-q` | Filter which components get selected by name and [namespace](/documentation/guide/component/namespaces.html). Can be a regex. Example: "^mynamespace/component1\$". | `String` |
| `--query_name` | Filter which components get selected by name. Can be a regex. Example: "^component1". | `String` |
| `--query_namespace`, `-n` | Filter which [namespaces](/documentation/guide/component/namespaces.html) get selected by [namespace](/documentation/guide/component/namespaces.html). Can be a regex. Example: "^mynamespace\$". | `String` |
| `--setup` | Which  [setup strategy](/documentation/guide/building-block/docker/setup-strategies.html) for creating the container to use [Docker Platform only]. | `String` |
...
| Argument | Description | Type |
|-|:----|-:
| `--cmd` | The command to execute for each viash config file in the [namespace](/documentation/guide/component/namespaces.html). **This is a required argument.** | `String` |
| `--config_mod`, `-c` | Modify a viash config at runtime using a [custom DSL](/documentation/reference/config/config-modding.html).  | `List[String]` |
