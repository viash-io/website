...
| `--query`, `-q` | Filter which components get selected by component and [namespace](/documentation/guide/component/namespaces.html) name. Can be a regex. Example: "^mynamespace/component1\$". | `String` |
| `--query_name` | Filter which components get selected by component name. Can be a regex. Example: "^component1". | `String` |
| `--query_namespace`, `-n` | Filter which namespaces get selected by [namespace](/documentation/guide/component/namespaces.html) name. Can be a regex. Example: "^mynamespace\$". | `String` |
