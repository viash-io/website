...
| `--setup`, `-s` | Which [setup strategy](/documentation/guide/building-block/docker/setup-strategies.html) for creating the container to use [Docker Platform only]. | `String` |
