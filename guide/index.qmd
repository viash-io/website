...
A Viash component is a combination of a [script](/guide/component/languages.html), a [config file](/reference/config/index.html) and an optional [unit test](/guide/component/unit-testing.html). We've split up the component guides per build target in order of complexity:
