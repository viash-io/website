...
All you need to do to add the [Docker platform](/reference/config/platforms/DockerPlatform.html) as a build target is adding `docker` to the `platforms` list in your [Viash config file](/reference/config/overview.html). 
