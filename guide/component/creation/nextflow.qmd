...
To add support for the [Nextflow platform](/reference/config/platforms/NextflowLegacyPlatform.html) as a build target, you need to add `nextflow` to the `platforms` section of your [Viash config file](/reference/config/index.html). To do this, add these lines to the bottom of your config file:
