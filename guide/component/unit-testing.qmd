...
To write a unit test for a component, you need two things: a definition in the [config file](/reference/config/index.html) and a script that runs the executable and verifies its output.  
