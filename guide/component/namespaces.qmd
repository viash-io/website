...
You can assign a component to a namespace by defining its [namespace](/reference/config/functionality.html#namespace) attribute in the [viash config file](/reference/config/index.html):
