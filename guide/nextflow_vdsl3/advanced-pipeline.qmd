...
9. Concatenate the TSVs into one by running the `combine_columns` module with [auto publishing](/reference/config/platforms/nextflow/#auto) enabled using the `auto` directive 
