...
Below is a first example Nextflow pipeline which uses just one VDSL3 module and with hard-coded input parameters (file1 and file2).
...
Please note that in order to run the above workflow in a VDSL3 context, one should use the following extended version:
