...
**Viash** supports a lot of [different scripting languages](/guide/component/languages.html) and requires you to be somewhat familiar with YAML to create and edit [config files](/reference/config/overview.html). You're free to use any editor of your choosing to write these files.  
...
[Viash config files](/reference/config/overview.html) are written in YAML, so it makes sense to have an extension for that language:
