...
To start off, either follow along with the [Nextflow component creation guide](/guide/component/creation/nextflow.html) to create a simple `hello_world` component that targets Nextflow or download the zip below containing the component in all [supported languages](/guide/component/languages.html).  
...
To let Viash generate a Nextflow module from your component, use the [viash build](/reference/viash/build.html) command:
...
To use generated modules inside an actual Nextflow pipeline, take a look at our [Pipeline Basics](/guide/data-workflow/nextflow-pipeline/pipeline-basics.html) guide.